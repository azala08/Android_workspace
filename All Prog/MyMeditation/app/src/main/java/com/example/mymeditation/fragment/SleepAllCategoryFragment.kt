...
import com.example.mymeditation.databinding.FragmentSleepAllCategoryBinding
import com.example.mymeditation.model.Sleep


class SleepAllCategoryFragment : Fragment() {

    lateinit var binding: FragmentSleepAllCategoryBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentSleepAllCategoryBinding.inflate(layoutInflater)
        val view = binding.root

        SetStatusBar.fromFragment(this, false)

        val sleep = listOf(
            Sleep(R.drawable.night_iceland, "Night Island", "45 MIN • SLEEP MUSIC", R.drawable.night_island_playoption, R.raw.calmlack),
        ...
        recyclerView = binding.rvSleepMusic
